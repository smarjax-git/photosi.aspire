...
using PhotoSi.Ordini;
using PhotoSi.Ordini.Data;
using PhotoSi.Ordini.Models;
...
namespace Test.PhotoSi.Ordini
{
    ...
    public class Fixture : IAsyncLifetime
    {
            ...
            : WebApplicationFactory<Program>
        {
            ...
            private readonly string _connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Orders;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
        }
