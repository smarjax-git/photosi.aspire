...
namespace PhotoSi.Ordini.Features.OrdiniRighe
{
    public class Index
    {
        ...
        public class QueryHandler : MediatR. IRequestHandler<Query, List<RigaOrdine>>
        {
            ...
            {
                return await _db.Ordini.Where(x => x.UserId == message.UserId && x.Id == message.OrderId)
                                   .Join(_db.OrdiniRighe.Include(o => o.Ordine),
                                        o => o.Id,
                                        r => r.OrdineId,
                                        (o, r) => r
                                    ).ToListAsync();
